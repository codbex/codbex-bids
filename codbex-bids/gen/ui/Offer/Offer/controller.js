angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.config(["entityApiProvider", function (entityApiProvider) {
		entityApiProvider.baseUrl = "/services/js/codbex-bids/gen/api/Offer/Offer.js";
	}])
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', function ($scope, $http, messageHub, entityApi) {
		...
		$http.get("/services/js/codbex-bids/gen/api/entities/Country.js").then(function (response) {
		...
		$http.get("/services/js/codbex-bids/gen/api/entities/OfferStatus.js").then(function (response) {
