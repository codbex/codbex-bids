...
const dao = require("codbex-bids/gen/dao/entities/OfferStatus");
const http = require("codbex-bids/gen/api/utils/http");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("OfferStatus not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-bids/gen/api/OfferStatus.js/" + entity.Id);
